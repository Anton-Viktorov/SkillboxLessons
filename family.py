...
class Experiment:
    ...
    #  __repr__ НИКОГДА не должен использовать __str__. __repr__ ОБЯЗАН вывести хоть что-то. Что угодно, хоть кусочек
    #  инфы, если все нельзя отразить, он используется, как правило в логах. И если repr сдох, то у тебя пустые логи,
    #  и ты понимаешь, что код упал, а что происходило сказать не можешь.
    #  .
    ...
    # ...    pass
    # ...
    # >>> class B:                  # класс в котором убили repr
    # ...    def __repr__(self):
    # ...       return 'потрачено!'
    # ...
    # >>> print(A())                                # выводим объект класса А
    # <__main__.A object at 0x000001E671D21AF0>     # инфа об объекте и памяти где его искать
    # >>>
    # >>> print(B())                                # выводим объект класса Б
    # потрачено!                                    # нифига. Где объект. Что это было. Ничего не понять, repr кривой.
