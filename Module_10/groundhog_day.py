...
def one_day():
    # TODO: если объект не присваивается, а только читается, не обязательно global писать.
    #  По крайней мере с точки зрения синтаксиса. По стилю тут не могу точно сказать, не оговорено.
    global events

    # TODO: тут мы действуем по причипу "проще просить прощения, чем испрашивать разрешения".
